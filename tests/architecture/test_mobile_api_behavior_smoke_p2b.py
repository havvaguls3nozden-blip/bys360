...
EXPECTED = {
    ...
    "push_notifications.py": [("POST", "/push/register-token"), ("POST", "/notifications/fcm-token"), ("POST", "/push/unregister-token"), ("GET", "/push/status")],
...
def test_mobile_route_contract_and_domain_ownership():
    ...
    assert len(set((m, r) for m, r, _ in routes)) == 28

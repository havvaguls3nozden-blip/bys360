...
from scripts.quality.bys360_phase3b_mobile_performance_item_helpers_gate_v1 import run_checks


def test_phase3b_mobile_performance_item_helpers_gate_v1() -> None:
    root = Path(__file__).resolve().parents[2]
    result = run_checks(root, write_report=False)

    assert result["item_helpers_gate_ok"] is True

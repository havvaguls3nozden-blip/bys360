...
def _load_gate(root: Path):
    script = root / "scripts" / "quality" / "bys360_mobile_security_suite_gate_p4c.py"
    spec = importlib.util.spec_from_file_location("bys360_mobile_security_suite_gate_p4c", script)

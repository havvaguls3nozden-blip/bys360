...
from scripts.quality.bys360_phase3c_score_route_service_gate_v1 import run_checks


def test_phase3c_score_route_service_gate_v1() -> None:
    root = Path(__file__).resolve().parents[2]
    result = run_checks(root, write_report=False)

    assert result["score_route_service_gate_ok"] is True

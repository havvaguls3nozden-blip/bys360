# BYS360 Effective Menu Next Safe Block Preflight V55B
- Generated at: 2026-06-26T16:18:31
...
- Target block line: 548
- Target block length: 11
- Projected raw target lines after split: 807
- Projected facade estimate: 813
- Unknown external names: []
- Used imports: ['_BYS360_PERSONEL_ROLE_MATRIX_VISIBILITY_V7_KEYS', '_BYS360_PERSONEL_ROLE_MATRIX_VISIBILITY_V7_MANAGER_ROLES', '_BYS360_PERSONEL_ROLE_MATRIX_VISIBILITY_V7_OBSOLETE_KEYS']
- Used assignments: []
- Used top-level functions: []
- Local assignments: ['_current', '_key', '_policy', '_policy_name']
- Calls: ['globals', 'isinstance', 'set']
- Attribute calls: ['_current.extend', '_current.update', '_policy.pop', '_policy.setdefault']

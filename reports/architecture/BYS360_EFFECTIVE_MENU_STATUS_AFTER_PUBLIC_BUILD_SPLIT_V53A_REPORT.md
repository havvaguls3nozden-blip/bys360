# BYS360 Effective Menu Status After Public Build Split V53A
- Generated at: 2026-06-26T15:55:59
- Status: READY_FOR_FUNCTION_OR_BLOCK_REVIEW
- Branch: phase4j-script-reduction-godobject-v1
- HEAD: 0d76764
- Target: app/services/settings/effective_menu.py
- Lines: 823
- Lines to go under 800: 24
- Top-level functions: 3
- All functions: 3
- Top-level assignments: 11
- Top-level blocks: 88
- Large top-level blocks >=6: 38
- Safe block candidates: 35
...
- kind=For | line=597 | length=6 | nested_funcs=0 | preview=for _set_name in ["PHASE3_2_MANAGER_VISIBLE_KEYS", "PHASE3_2_GENERAL_VISIBLE_KEYS", "ROLE_MATRIX_RUNTIME_AUTHORITY_KEYS", "PERFORMANCE_ROLE_MATRIX_KEYS"]:

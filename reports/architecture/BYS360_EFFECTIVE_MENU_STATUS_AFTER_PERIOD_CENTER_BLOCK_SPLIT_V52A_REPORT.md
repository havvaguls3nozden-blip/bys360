# BYS360 Effective Menu Status After Period Center Block Split V52A
- Generated at: 2026-06-26T15:49:20
- Status: READY_FOR_FUNCTION_OR_BLOCK_REVIEW
- Branch: phase4j-script-reduction-godobject-v1
- HEAD: bfbfdad
- Target: app/services/settings/effective_menu.py
- Lines: 827
- Lines to go under 800: 28
...
- preview: def build_menu_visibility_map(user, *args, **kwargs):  # type: ignore[no-redef]
...
- kind=FunctionDef | line=815 | length=12 | nested_funcs=1 | preview=def build_menu_visibility_map(user, *args, **kwargs):  # type: ignore[no-redef]
...
- kind=Try | line=577 | length=6 | nested_funcs=0 | preview=try:

...
RECOMMENDED_INDEXES: tuple[RecommendedIndex, ...] = (
    ...
    RecommendedIndex("ayarlar", "system_settings", "ix_phase6_system_settings_key_active", ("key", "is_active"), "Sistem ayari anahtar okumasi."),
    RecommendedIndex("ayarlar", "module_settings", "ix_phase6_module_settings_module_key", ("module", "key"), "Modul bazli ayar okuma/yazma."),
    RecommendedIndex("ayarlar", "settings_change_logs", "ix_phase6_settings_logs_created", ("created_at", "changed_by_user_id"), "Ayar degisiklik gecmisi ve denetim izi."),

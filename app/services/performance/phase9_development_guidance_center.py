...
# BYS360 DEFECT AR: ensure_phase9_schema()/
# seed_phase9_development_guidance_settings() (ve phase9_schema_sql() DDL
# ureticisi) kaldirildi -- repo genelinde (app/, tests/, scripts/) hicbir
# gercek cagirani yoktu. Canli "gelisim rehberligi" ozelligi
# app/performance/phase10_development_guidance_ui.py uzerinden calisir; bu
# dosyanin geri kalani degismedi.

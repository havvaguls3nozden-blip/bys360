...
# BYS360 DEFECT AR: ensure_phase11_tables()/seed_phase11_settings()
# kaldirildi -- repo genelinde (app/, tests/, scripts/) hicbir gercek
# cagirani yoktu. Ayrica DDL'i (TIMESTAMP WITHOUT TIME ZONE DEFAULT NOW())
# PostgreSQL'e ozgu NOW() ifadesi icerdigi icin SQLite'ta zaten calismazdi
# -- calisir hale getirmek yerine kaldirmak dogru olan, cunku canli hicbir
# caller'i yok.

...
def export_manager_summary_csv(s):
    s = s or {}; a = s.get('analytics') or {}; rows = [['BYS360 Yönetici Geri Bildirim Özeti'], ['Nabız ortalaması', s.get('pulse_average','')], ['Katılımcı', a.get('participant_count',0)], ['Risk serisi', a.get('risk_user_count',0)], [], ['Kampanya','Durum','Yanıt']]

...
def apply_v215_category_period_scope_wrapper(
    current_build_menu_visibility_map,
    *,
    logging,
    normalize_role_name,
    ...
    """Apply the V2.1.5 category period scope wrapper while preserving legacy behavior."""
    try:
...
def apply_v214_category_scope_wrapper(
    current_build_menu_visibility_map,
    *,
    logging,
    normalize_role_name,
    ...
    """Apply the V2.1.4 category scope wrapper while preserving legacy behavior."""
    try:

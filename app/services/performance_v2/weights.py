...
def resolve_weight_plan(employee, period=None, resolved_chain=None) -> WeightPlan:
    ...
    # Tek amirli / özel zincirli kayıtlarda caller resolved_chain göndermeyi unutsa bile
    # ağırlık planı gerçek çözülen zincire göre kurulmalı. Aksi halde 50/50 varsayımı
    # yüzünden tek amirli sonuçlar yarıya düşebiliyor.

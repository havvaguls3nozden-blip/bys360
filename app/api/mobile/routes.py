...
from app.api.mobile.domains.auth import (
    datetime,
    timezone,
    mean,
    Any,
...
from app.api.mobile.domains.dashboard import (
    datetime,
    timezone,
    mean,
    Any,
...
from app.api.mobile.domains.personnel_read import (
    User,
    jsonify,
    mobile_api_bp,
    request,
    require_mobile_user,
    mobile_personnel_list,
)
from app.api.mobile.domains.notifications import (
    datetime,
    timezone,
    mean,
    Any,
    ...
    mobile_me_response,
    require_mobile_user,
    mobile_notification_mark_read_v2864,
    mobile_notifications_mark_all_read_v2864,
)
from app.api.mobile.domains.support_survey_write import (
    datetime,
    timezone,
    mean,
    Any,
...
from app.api.mobile.domains.communication_v1_write import (
    datetime,
    timezone,
    mean,
    Any,
    ...
    mobile_b46_communication_send_message,
    mobile_b46_communication_create_thread,
)
from app.api.mobile.domains.communication_v2_write import (
    datetime,
    timezone,
    mean,
    Any,
...
from app.api.mobile.domains.assistant_chat import (
    EvaluationAssignment,
    Notification,
    SupportTicket,
    User,
...
from app.api.mobile.domains.personnel_write_all import (
    ...
    mobile_personnel_add_alias,
)
from app.api.mobile.domains.kpi_target_management import (
    datetime,
    timezone,
    mean,
    Any,
...
# SCORE100 V1E: imports restored from former wildcard imports for Ruff F821
from app.api.mobile.domains.personnel_write_all import _can_mobile_create_personnel

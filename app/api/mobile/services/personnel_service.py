...
def mobile_personnel_create(*args, **kwargs):
    return getattr(_routes_module(), '_bys360_legacy_mobile_personnel_create')(*args, **kwargs)


def _mobile_created_personnel_row(*args, **kwargs):
    return getattr(_routes_module(), '_bys360_legacy__mobile_created_personnel_row')(*args, **kwargs)

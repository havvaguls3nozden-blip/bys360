# -*- coding: utf-8 -*-
"""
BYS360 Mobile Performance Return Helpers Delegate P3.4 V2.17.38

This script delegates only return/withdraw helper functions from
...
VERSION = "V2.17.38"
PATCH_MARKER = "BYS360_MOBILE_PERFORMANCE_RETURN_HELPERS_DELEGATE_P3_4_V2_17_38"
TARGET_REL = Path("app/api/mobile/performance_routes.py")
SERVICE_REL = Path("app/api/mobile/services/performance_task_service.py")
REPORT_JSON_REL = Path("reports/quality/bys360_mobile_performance_return_helpers_delegate_p3_4_v2_17_38_report.json")
REPORT_MD_REL = Path("reports/quality/bys360_mobile_performance_return_helpers_delegate_p3_4_v2_17_38_report.md")
TARGETS = ["_v2837_return_assignment", "_v2837_withdraw_assignment"]
...
def apply(project_root: Path) -> Dict[str, object]:
    ...
    quarantine_root = project_root / "_local_quarantine" / f"bys360_mobile_performance_return_helpers_delegate_p3_4_{stamp}"
...
def write_report(project_root: Path, result: Dict[str, object]) -> None:
    ...
    lines: List[str] = []
    lines.append("# BYS360 Mobile Performance Return Helpers Delegate P3.4 V2.17.38\n")
    lines.append("Bu rapor gercek yazma endpointlerine dokunmadan iade/geri cekme helper fonksiyonlarinin servis delegasyonu sonucunu gosterir.\n")
    lines.append("## Durum\n")

...
def main() -> int:
    ...
    print("BYS360 Kurumsal Bilgilendirme Merkezi Faz 7 canlı geçiş ve kullanım paketi uygulanıyor...")
    print(f"ProjectRoot={root}")
    patch_docs_and_css(root)
    patch_base(root)
    patch_overview(root)
    patch_test(root)
    patch_system(root)
    ...
    for rel in [
        ...
        "app/static/css/corporate_information_center_v3_0_phase7.css",
        "docs/BYS360_CORPORATE_INFORMATION_CENTER_V3_0_PHASE7_USAGE_GUIDE.md",
        "docs/BYS360_CORPORATE_INFORMATION_CENTER_V3_0_PHASE7_LIVE_RELEASE_CHECKLIST.md",
        "docs/BYS360_CORPORATE_INFORMATION_CENTER_V3_0_PHASE7_ROLLBACK_PLAN.md",
    ]:
        print(" -", rel)
    return 0

...
def main() -> int:
    ...
    repair_path = root / "scripts/live/repair_bys360_live_full_overlay_v2_17_61.py"
    if not repair_path.exists():
        raise SystemExit(f"Repair script bulunamadı: {repair_path}")
    spec = importlib.util.spec_from_file_location("bys360_live_full_overlay_v2_17_61", repair_path)

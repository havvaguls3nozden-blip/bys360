...
def main() -> int:
    ...
    print("BYS360_QUALITY_10_10_P11_B1A_MOBILE_ROUTES_SPLIT_CANDIDATES_START")
    ...
    print("BYS360_QUALITY_10_10_P11_B1A_DECORATOR_SUMMARY")
    for k, v in by_decorator.most_common():
        print(f"{v:>4} | {k}")
    print("BYS360_QUALITY_10_10_P11_B1A_DECISION_SUMMARY")
    for k, v in by_decision.most_common():
        print(f"{v:>4} | {k}")
    print("BYS360_QUALITY_10_10_P11_B1A_ROUTE_RISK_SUMMARY")
    for k, v in by_risk.most_common():
        print(f"{v:>4} | {k}")
    print("BYS360_QUALITY_10_10_P11_B1A_FIRST_SPLIT_CANDIDATES")
    ...
    print("BYS360_QUALITY_10_10_P11_B1A_LOW_RISK_CANDIDATES")
    for f in low_candidates[:args.limit]:
        route = ",".join(r["route"] for r in f["routes"])
        methods = ",".join(f["methods"]) if f["methods"] else "-"
        print(f"{f['lines']:>4} | {f['domain']} | {f['start']}-{f['end']} | {f['name']} | methods={methods} | route={route}")
    print("BYS360_QUALITY_10_10_P11_B1A_RECOMMENDATION")
    ...
    print("BYS360_QUALITY_10_10_P11_B1A_MOBILE_ROUTES_SPLIT_CANDIDATES_OK")
    return 0

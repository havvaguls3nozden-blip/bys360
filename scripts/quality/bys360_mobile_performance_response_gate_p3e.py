...
PACKAGE = "BYS360_CLAUDE_SCORE_UPLIFT_P3E_MOBILE_PERFORMANCE_RESPONSE_GATE"
...
TARGET_SCENARIOS = [
    ...
    {"feature": "performance", "method": "GET", "suffix": "/performance/approvals", "concrete": "/api/mobile/performance/approvals"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/scorecards", "concrete": "/api/mobile/performance/scorecards"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/rules-summary", "concrete": "/api/mobile/performance/rules-summary"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/criteria", "concrete": "/api/mobile/performance/criteria"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/third-manager", "concrete": "/api/mobile/performance/third-manager"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/tasks", "concrete": "/api/mobile/performance/tasks"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/manager-tasks", "concrete": "/api/mobile/performance/manager-tasks"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/tasks/<int:assignment_id>", "concrete": "/api/mobile/performance/tasks/1"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/tasks/<int:assignment_id>/score-form", "concrete": "/api/mobile/performance/tasks/1/score-form"},
    {"feature": "performance", "method": "POST", "suffix": "/performance/tasks/<int:assignment_id>/score-form", "concrete": "/api/mobile/performance/tasks/1/score-form", "json": {"scores": []}},
    {"feature": "performance", "method": "POST", "suffix": "/performance/tasks/<int:assignment_id>/score-action", "concrete": "/api/mobile/performance/tasks/1/score-action", "json": {"action": "draft"}},
    {"feature": "performance", "method": "GET", "suffix": "/performance/full-feature-summary", "concrete": "/api/mobile/performance/full-feature-summary"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/president-approvals", "concrete": "/api/mobile/performance/president-approvals"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/publish-preapproval", "concrete": "/api/mobile/performance/publish-preapproval"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/history-archive", "concrete": "/api/mobile/performance/history-archive"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/in-period-notes", "concrete": "/api/mobile/performance/in-period-notes"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/in-period-notes/v2", "concrete": "/api/mobile/performance/in-period-notes/v2"},
    {"feature": "performance", "method": "POST", "suffix": "/performance/in-period-notes/v2", "concrete": "/api/mobile/performance/in-period-notes/v2", "json": {"note": ""}},
    {"feature": "performance", "method": "GET", "suffix": "/performance/development-suggestions", "concrete": "/api/mobile/performance/development-suggestions"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/reports", "concrete": "/api/mobile/performance/reports"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/risk-analysis", "concrete": "/api/mobile/performance/risk-analysis"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/note-scorecard", "concrete": "/api/mobile/performance/note-scorecard"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/manager-view", "concrete": "/api/mobile/performance/manager-view"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/weights", "concrete": "/api/mobile/performance/weights"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/categories", "concrete": "/api/mobile/performance/categories"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/reminders", "concrete": "/api/mobile/performance/reminders"},
    {"feature": "performance", "method": "GET", "suffix": "/performance/in-period-note-options", "concrete": "/api/mobile/performance/in-period-note-options"},
]
...
def build_inventory(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "feature_smoke": {"performance": True},
...
def runtime_route_map(root: Path) -> dict[str, Any]:
    try:
        ...
        return {
            ...
            "sample_mobile_routes": mobile_routes[:100],
            "error": "",
        }
...
def run_pytest(root: Path) -> dict[str, Any]:
    cmd = [sys.executable, "-m", "pytest", "tests/architecture/test_mobile_api_performance_response_p3e.py", "-q"]
    result = run_subprocess(cmd, root)
    result["mode"] = "pytest_targeted_performance_response_p3e"
    return result
...
def ensure_active_scope(root: Path) -> dict[str, Any]:
    ...
    marker = "# BYS360_P3E_ACTIVE_SCOPE_MARKER"
    block_lines = [
        "",
        marker,
        "try:",
...
def run_checks(root: Path, *, compile_all: bool = False, app_factory: bool = False, secret_gate_run: bool = False, pytest_gate: bool = False, write_report: bool = True) -> dict[str, Any]:
    ...
    result: dict[str, Any] = {
        ...
        "next_actions": [
            "P3E temizse performans mobil response-code smoke kapisi runtime route haritasiyla birlikte kurulmus kabul edilebilir.",
            "P3F'de P3A-P3E mobil response kapilari tek runner altinda birlestirilebilir.",
        ],
    }
    if write_report:

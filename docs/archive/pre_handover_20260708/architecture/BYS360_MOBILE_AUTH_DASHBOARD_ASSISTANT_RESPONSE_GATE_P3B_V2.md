# BYS360 P3B V2 — Mobil Auth/Dashboard/Asistan Response Gate
...
V2 notu: runtime route map kontrolü P3A ile aynı suffix tabanlı güvenilir parse mantığına alınmıştır. Büyük stdout çıktısı tail üzerinden değil tam stdout üzerinden parse edilir.
